            ...
            <div className='wrapper w-96 bg-transparent border-2 border-white backdrop-blur-30 shadow-md text-white rounded-lg px-5 py-12 fixed right-14 top-1/2 transform -translate-x-20 -translate-y-1/2'>
                <form action="">
                    ...
                    <div className="input-box">
                        <input className="w-full h-full bg-transparent outline-none border border-white border-opacity-20 rounded-full text-white text-lg px-8 py-6 placeholder-white" type="text" placeholder='Email Address' required />
                    </div>

                    <div className='input-box'>
                        <input className="w-full h-full bg-transparent outline-none border border-white border-opacity-20 rounded-full text-white text-lg px-8 py-6 placeholder-white" type="password" placeholder='Username' required />
                    </div>
                    ...
                    <button type='submit' className="w-full h-12 bg-white rounded-full shadow-md mt-8 text-lg font-semibold text-gray-800">Register</button>
