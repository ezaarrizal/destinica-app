...
const ArticleUpload = (props) => {
    ...
    const handleShowConfirmation = (id, judul_artikel, isi_artikel, gambar) => {
        ...
        <div>
            <div className="flex w-full h-fit bg-ijo text-white align flex-col">
                <div className="flex">
                    ...
                    <a href="/artupload" class="inline-block bg-warnabutton hover:bg-button-hover hover:text-white text-black font-bold py-2 px-4 rounded w-25 h-10 mt-10">
                        Upload
                    </a>
                </div>
                    ...
                    return (
                        <div key={i} className="flex h-3/6  mt-20 content-center">
                            ...
                            <div className="w-1/2">
                                    ...
                                    {activeDropdown === i && (
                                        ...
                                        >
                                            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                                                <li>
                                                    <Link href={`articles/edit/${data.id}`}>
                                                ...
                                                <li>
                                                    <Link href="#" onClick={(e) => { e.preventDefault(); handleShowConfirmation(data.id, data.judul_artikel, data.isi_artikel, data.gambar); }}>
                                                        <div className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                            Delete
                                                        </div>
                                                    </Link>
                                ...
                                <div className="mt-10">
                                    <Link href={`articles/${data.id}`} className="text-white hover:text-button-hover underline underline-offset-2">Read Full Article</Link>
                                </div>
